  ...
  type variant = Realistic_202103115_t.variant =
    { id : string
    ; value : prompt
    }
  ...
  type var_number_or_unspecified = Realistic_202103115_t.var_number_or_unspecified
  
  type var_nip = Realistic_202103115_t.var_nip = { testValue : string }
  
  type date = Realistic_202103115_t.date =
    { year : int
    ; month : int
    ; day : int
    }
  ...
  type constant_token = Realistic_202103115_t.constant_token = { value : string }
