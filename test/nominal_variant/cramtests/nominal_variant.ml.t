  ...
  $ cat nominal_variant.ml | ocamlformat --impl -
  ...
  let json_of_string s =
    ...
    | `Int 2 ->
      Json.json_of_string s
    | `Int 1 ->
      convert_from_1_to_latest (Nominal_variant_1_j.json_of_string s)
    | v ->
  ...
  let read_json_from_file fname =
    ...
    | `Int 2 ->
      Atdgen_runtime.Util.Json.from_file Json.read_json fname
    | `Int 1 ->
