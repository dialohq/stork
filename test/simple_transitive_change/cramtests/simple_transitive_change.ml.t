  ...
  $ cat simple_transitive_change.ml | ocamlformat --impl -
  ...
  let employee_of_string s =
    ...
    | `Int 1 ->
      convert_from_1_to_latest (Simple_transitive_change_1_j.employee_of_string s)
    | v ->
    ...
    | `Int 1 ->
      convert_from_1_to_latest
        (Atdgen_runtime.Util.Json.from_file
           Simple_transitive_change_1_j.read_employee
           fname)
    | v ->
      invalid_arg ("Unknown document version: '" ^ version_to_string v ^ "'")
