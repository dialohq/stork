  ...
  > cat rescript_simple_1_t.ml
  > echo ---
  > cat rescript_simple_1_t.mli
  > echo ---
  > cat rescript_simple_1_j.ml
  > echo ---
  > cat rescript_simple_1_j.mli
  > echo ---
  > cat rescript_simple_2_t.ml
  > echo ---
  > cat rescript_simple_2_t.mli
  > echo ---
  > cat rescript_simple_2_j.ml
  > echo ---
  > cat rescript_simple_2_j.mli
  > echo ---
  > cat rescript_simple_upgrader_t.ml
  > echo ---
  > cat rescript_simple_upgrader_t.mli
  > echo ---
  > cat rescript_simple.ml
  > echo ---
  > cat rescript_simple.mli
  ...
  module Json = Rescript_simple_2_j
  module From_1_to_2 = struct
  ...
  let employee_of_string s = match (get_version s) with
    ...
    | `Int 1 -> convert_from_1_to_latest (Rescript_simple_1_j.employee_of_string s)
  ...
  let read_employee_from_file fname = match (get_version_from_file fname) with
    ...
    | `Int 1 -> convert_from_1_to_latest (Atdgen_runtime.Util.Json.from_file Rescript_simple_1_j.read_employee fname)
    | v -> invalid_arg ("Unknown document version: '" ^ version_to_string v ^ "'")
