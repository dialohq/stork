  ...
  $ cat rescript_simple.ml | ocamlformat --enable-outside-detected-project --impl -
  ...
  let read_employee json =
    ...
    | `Int 2 -> Json.read_employee json
    | `Int 1 -> convert_from_1_to_latest (Rescript_simple_1_bs.read_employee json)
